...
const SidebarInset = React.forwardRef(({ className, ...props }, ref) => {
  return (
    (<main
      ref={ref}
      className={cn(
        "relative flex min-h-svh flex-1 flex-col gap-4 bg-white dark:bg-slate-950",
...
const SidebarHeader = React.forwardRef(({ className, ...props }, ref) => {
  return (
    (<div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-col gap-3 px-2 py-5", className)}
      {...props} />)
  );
})
...
const SidebarContent = React.forwardRef(({ className, ...props }, ref) => {
  return (
    (<div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto scrollbar-gutter group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props} />)
  );
...
const SidebarGroupLabel = React.forwardRef(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    (<Comp
      ...
      className={cn(
        "duration-200 flex gap-2 h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:shrink-0",
